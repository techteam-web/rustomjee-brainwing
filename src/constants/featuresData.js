...
//
// For slides with exact line breaks: paragraphs is an array of objects with 'lines' arrays
// Each 'lines' array contains the exact lines for that paragraph block
//
// ============================================
...
export const type1SlidesData = [
  ...
  // ============================================
  {
    ...
    rightSection: {
      ...
      paragraphs: [
        {
          lines: [
            "Some places change the way you think about building.",
            "Mount Mary is one of them.",
          ]
        },
        {
          lines: [
            "This is a part of Mumbai where nothing new can truly come again. What exists here is finite and that scarcity brings with it a responsibility. When",
            "something is this rare, it demands restraint.",
            "Every decision has to be considered, edited, intentional.",
          ]
        },
        {
          lines: [
            "That is where the three disciplines came together - architecture, interiors, and landscape; not as separate expressions, but as one composed",
            "thought. Sanjay Puri brings a clarity of form that allows the building to stand as an urban icon, without excess. Patty Mak's interiors are",
            "understated, international, and timeless.",
            "And Kunal Maniar's landscapes create pauses that are rare in the city.",
          ]
        },
        {
          lines: [
            "Mount Mary remains the most protected edge of Bandra Bay, elevated, inward-looking, and quietly connected. Cliff Tower reflects that",
            "sensibility. Just a handful of residences, carefully edited.",
            "Privacy here is not an amenity, it is a principle.",
          ]
        },
        {
          lines: [
      ...
      signature: {
        signatureImageSrc: "/slides/Boman_Irani_Sign.png",
      }
  ...
  // ============================================
  {
    ...
    paragraphs: [
      {
        lines: [
          "Rustomjee Cliff Tower is conceived as a sculptural response",
          "to light, height, and horizon. Positioned at the highest point of Mount Mary,",
          "the architecture engages directly with elevation, openness, and expansive sightlines, allowing the building to",
          "act as a frame for the sky and sea.",
          "The tower's geometry evolves from a carefully edited footprint,",
          "opening outward to capture uninterrupted vistas on multiple sides.",
  ...
  // ============================================
  {
    ...
    backgroundSrc: "/slides/bg.webp",
    backgroundTree: "/slides/tree-bg.webp",
